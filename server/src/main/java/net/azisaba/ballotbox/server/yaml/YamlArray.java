...
public class YamlArray extends ArrayList<Object> implements YamlMember {
  ...
  public YamlObject getObject(int index) {
    return new YamlObject(yaml, (Map<String, Object>) get(index));
  }

  @NotNull
  @SuppressWarnings("unchecked")
  public YamlArray getArray(int index) {
    return new YamlArray(yaml, (List<Object>) get(index));
  }
  ...
  @SuppressWarnings("unchecked")
  public <T> void forEachAsType(@NotNull Consumer<T> action) {
  ...
  @Override
  public @NotNull Object getRawData() {
    return this;
  }
}
